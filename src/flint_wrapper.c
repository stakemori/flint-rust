...
void wrapped_fmpz_init(fmpz_t f)
{
  fmpz_init(f);
}

void wrapped_fmpz_init_set(fmpz_t f, const fmpz_t g)
{
  fmpz_init_set(f, g);
}
...
void wrapped_fmpz_set_ui(fmpz_t f, ulong val)
{
  fmpz_set_ui(f, val);
}

void wrapped_fmpz_neg_ui(fmpz_t f, ulong val)
{
  fmpz_neg_ui(f, val);
}
...
void wrapped_fmpz_zero(fmpz_t f)
{
  fmpz_zero(f);
}

void wrapped_fmpz_one(fmpz_t f)
{
  fmpz_one(f);
}

int wrapped_fmpz_is_zero(const fmpz_t f)
{
  return fmpz_is_zero(f);
}

int wrapped_fmpz_is_one(const fmpz_t f)
{
  return fmpz_is_one(f);
}

void wrapped_fmpz_swap(fmpz_t f, fmpz_t g)
{
  fmpz_swap(f, g);
}

int wrapped_fmpz_is_even(const fmpz_t f)
{
  return fmpz_is_even(f);
}

int wrapped_fmpz_is_odd(const fmpz_t f)
{
  return fmpz_is_odd(f);
}

void wrapped_fmpz_neg(fmpz_t f1, const fmpz_t f2)
{
  fmpz_neg(f1, f2);
}
